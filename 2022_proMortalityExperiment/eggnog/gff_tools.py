...
def extract_Morality_Experiment_CDS():
    genomic_resources_dir = Path("/nfs/chisholmlab001/kve/genomic_resources/strains")

    genome_io_dir = genomic_resources_dir / 'vir' / 'PSSP7'
    
    gff_path = genome_io_dir / "PSSP7.gff"
    fasta_path = genome_io_dir / "PSSP7.fna"
    fna_outpath = genome_io_dir / "PSSP7_extracted_CDS.fna"
    faa_outpath = genome_io_dir / "PSSP7_extracted_Proteins.faa"
...
if __name__ == "__main__":
    ...
    # read_blast_annotations()
    # annotate_joined_df()
    extract_Morality_Experiment_CDS()