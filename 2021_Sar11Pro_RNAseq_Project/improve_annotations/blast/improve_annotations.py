...
def df2gff(annotation_df, outpath, genome_record):
...
def extract_cds_na(gff_df, ref_seq, fasta_outpath):
    ...
    for i, gene in cds_df.iterrows():
        ...
        gene_seq_record = SeqRecord(na_seq, id=gene['ID'], name=str(gene['Name']), 
                                    description=f"{gene['ID']} making {gene['product']} on {gene['strand']} strand")
...
def extract_Sar11Pro_project_CDS():
    gff_path = Path("/nfs/chisholmlab001/kve/2021_Sar11Pro_RNAseq_Project/data/input_data/culture_genome_annotations/MIT9301.gff")
    fasta_path = Path("/nfs/chisholmlab001/kve/2021_Sar11Pro_RNAseq_Project/data/input_data/culture_genome_refs/MIT9301.fna")
    fna_outpath = Path("/nfs/chisholmlab001/kve/2021_Sar11Pro_RNAseq_Project/improving_annotations/MIT9301_extracted_cds.fna")
    faa_outpath = Path("/nfs/chisholmlab001/kve/2021_Sar11Pro_RNAseq_Project/improving_annotations/MIT9301_extracted_cds.faa")
